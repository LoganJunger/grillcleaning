        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold font-bricolage text-gray-900">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link href="/blog" className="text-gray-600 hover:text-orange-500 font-medium transition-colors">
                Blog
              </Link>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t space-y-3">
              ...
              <Link href="/blog" className="block text-gray-600 hover:text-orange-500 font-medium" onClick={() => setMobileMenuOpen(false)}>
                Blog
              </Link>
